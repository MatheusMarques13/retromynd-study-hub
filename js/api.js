(function(){
  ...
  function createLoginOverlay() {
    ...
    o.id = OVERLAY_ID;
    o.innerHTML = '<style>'
      +'#'+OVERLAY_ID+'{position:fixed;inset:0;z-index:10000;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#fce4ec,#fff3e0 50%,#e8f5e9);font-family:Raleway,sans-serif;transition:opacity .4s}'
      ...
      +'.rm-hd{text-align:center;margin-bottom:1rem}.rm-em{font-size:2rem}.rm-tt{font-size:2.2rem;color:#d4726a;margin:0;font-family:Caveat,cursive;font-weight:700}'
      +'.rm-tabs{display:flex;margin-bottom:1rem;border-radius:8px;overflow:hidden;border:2px solid #e8d5b5}'
      +'.rm-tb{flex:1;padding:.55rem;text-align:center;font-size:.75rem;font-weight:700;letter-spacing:.08em;cursor:pointer;background:#fff8f0;color:#b8a080;border:none;font-family:Raleway,sans-serif;transition:all .2s}'
      ...
      +'.rm-f{width:100%;padding:.55rem .7rem;border:1.5px solid #e0d5c5;border-radius:8px;font-size:.8rem;background:#fffef7;color:#5a4a3a;margin-bottom:.45rem;box-sizing:border-box;font-family:Raleway,sans-serif;outline:none;transition:border .2s}'
      +'.rm-f:focus{border-color:#f9a8b8}.rm-f::placeholder{color:#c8b8a8}'
      +'.rm-bt{width:100%;padding:.6rem;border:none;border-radius:24px;font-size:.83rem;font-weight:700;cursor:pointer;font-family:Raleway,sans-serif;transition:all .2s;margin-top:.5rem}'
  ...
  function injectProfileBar(user) {
    ...
    bar.innerHTML = '<style>'
      ...
      +'border-bottom:2px solid #f2d6d0;font-family:Raleway,sans-serif;position:relative;z-index:100;'
      ...
      +'.pb-name{font-size:.85rem;color:#d4726a;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;'
      +'font-family:Caveat,cursive!important;font-size:1.1rem!important;transition:color .3s}'
      +'.pb-meta{font-size:.6rem;color:#b8a080;font-family:Raleway,sans-serif;transition:color .3s}'
      ...
      +'font-family:Raleway,sans-serif;transition:all .2s;border-radius:12px;font-weight:600}'
      ...
      +'body.retro-dark .pb-name{color:#f5c518!important;font-family:VT323,monospace!important;font-size:1.1rem!important}'
      ...
      +'border-left:2px solid #f2d6d0;z-index:9999;overflow-y:auto;font-family:Raleway,sans-serif;'
      ...
      +'.pp-name{font-family:Caveat,cursive;font-size:1.8rem;font-weight:700;color:#d4726a;margin:0;transition:all .3s}'
      ...
      +'.pp-label{font-size:.6rem;color:#b8a080;letter-spacing:.1em;font-weight:700;margin-bottom:.5rem;font-family:Raleway,sans-serif}'
      +'.pp-input{width:100%;padding:.5rem .7rem;background:#fffef7;border:1.5px solid #e0d5c5;color:#5a4a3a;font-size:.8rem;'
      +'font-family:Raleway,sans-serif;outline:none;box-sizing:border-box;border-radius:8px;margin-bottom:.4rem;transition:all .3s}'
      ...
      +'font-weight:700;cursor:pointer;font-family:Raleway,sans-serif;border-radius:20px;margin-top:.3rem;transition:all .3s}'
      ...
      +'color:#e8477a;font-size:.75rem;font-weight:700;cursor:pointer;font-family:Raleway,sans-serif;text-align:center;'
